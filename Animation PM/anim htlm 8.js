...
(lib.CachedBmp_180 = function() {
	this.initialize(ss["anim htlm 8_atlas_"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_179 = function() {
	this.initialize(ss["anim htlm 8_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/anim htlm 8_atlas_.png", id:"anim htlm 8_atlas_"},
		{src:"images/anim htlm 8_atlas_2.png", id:"anim htlm 8_atlas_2"},
